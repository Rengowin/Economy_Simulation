...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""BuildModus"",
            ""id"": ""0c8017cc-cb13-4f90-8f7e-918b9c968c98"",
            ""actions"": [
                {
                    ""name"": ""SpawnSawMill"",
                    ""type"": ""Button"",
                    ""id"": ""d0bc478c-7c5a-4019-93a5-9d8666fd72e6"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false,
                ...
                {
                    ""name"": ""SpawnWoodCutter"",
                    ""type"": ""Button"",
                    ""id"": ""edda01ee-0fc6-41a3-9707-18866ce1edf0"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false,
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a4519f66-6526-455f-9f6f-18ded43ec7ea"",
                    ""path"": ""<Keyboard>/2"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""593c3b5d-14c7-4d6f-9813-4fd3f88aaecd"",
                    ""path"": ""<Keyboard>/1"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_BuildModus.enabled, "This will cause a leak and performance issues, InputSystem_Actions.BuildModus.Disable() has not been called.");
    }
    ...
    // BuildModus
    private readonly InputActionMap m_BuildModus;
    ...
    /// </summary>
    public struct BuildModusActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BuildModusActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "BuildModus/SpawnSawMill".
        /// </summary>
        public InputAction @SpawnSawMill => m_Wrapper.m_BuildModus_SpawnSawMill;
        /// <summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_BuildModus; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="BuildModusActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(BuildModusActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="BuildModusActions" />
        public void AddCallbacks(IBuildModusActions instance)
        {
            if (instance == null || m_Wrapper.m_BuildModusActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BuildModusActionsCallbackInterfaces.Add(instance);
            @SpawnSawMill.started += instance.OnSpawnSawMill;
            @SpawnSawMill.performed += instance.OnSpawnSawMill;
            @SpawnSawMill.canceled += instance.OnSpawnSawMill;
        ...
        /// </remarks>
        /// <seealso cref="BuildModusActions" />
        private void UnregisterCallbacks(IBuildModusActions instance)
        {
            @SpawnSawMill.started -= instance.OnSpawnSawMill;
            @SpawnSawMill.performed -= instance.OnSpawnSawMill;
            @SpawnSawMill.canceled -= instance.OnSpawnSawMill;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="BuildModusActions.UnregisterCallbacks(IBuildModusActions)" />.
        /// </summary>
        /// <seealso cref="BuildModusActions.UnregisterCallbacks(IBuildModusActions)" />
        public void RemoveCallbacks(IBuildModusActions instance)
        {
            if (m_Wrapper.m_BuildModusActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="BuildModusActions.AddCallbacks(IBuildModusActions)" />
        /// <seealso cref="BuildModusActions.RemoveCallbacks(IBuildModusActions)" />
        /// <seealso cref="BuildModusActions.UnregisterCallbacks(IBuildModusActions)" />
        public void SetCallbacks(IBuildModusActions instance)
        {
            foreach (var item in m_Wrapper.m_BuildModusActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BuildModusActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="BuildModusActions" /> instance referencing this action map.
    /// </summary>
    public BuildModusActions @BuildModus => new BuildModusActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "BuildModus" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="BuildModusActions.AddCallbacks(IBuildModusActions)" />
    /// <seealso cref="BuildModusActions.RemoveCallbacks(IBuildModusActions)" />
    public interface IBuildModusActions
    {
        /// <summary>
        /// Method invoked when associated input action "SpawnSawMill" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnSpawnSawMill(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "SpawnWoodCutter" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
